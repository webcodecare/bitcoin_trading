...
export default function AdminReports() {
  ...
  const reportTypes = [
    ...
    { value: "signal_effectiveness", label: "Signal Effectiveness", icon: TrendingUp, description: "Trading signal performance, accuracy rates, user engagement" },
    ...
    { value: "revenue_analytics", label: "Revenue Analytics", icon: DollarSign, description: "Payment trends, MRR, customer lifetime value, revenue forecasts" },
  ];

      ...
      <section className="py-16 bg-gradient-to-r from-background to-muted/20">
        <div className="container px-4 mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Get in <span className="crypto-gradient bg-clip-text text-transparent">
              Touch
            </span>
          </h1>
            ...
            {contactMethods.map((method, index) => (
              <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-8">
                  <div className="crypto-gradient w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    {method.icon}
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full p-3 border border-border rounded-md bg-background focus:ring-2 focus:ring-primary focus:border-primary"
                    >
                      {categories.map((cat) => (
                  ...
                  <Button type="submit" className="w-full crypto-gradient text-white">
            ...
            <div className="space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div>
                    <h4 className="font-semibold mb-2">CryptoStrategy Pro</h4>

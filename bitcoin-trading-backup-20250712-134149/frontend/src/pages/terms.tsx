        ...
        <div className="container px-4 mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="mb-8">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  Welcome to CryptoStrategy Pro. These Terms of Service ("Terms") govern your use of our 
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  CryptoStrategy Pro provides cryptocurrency trading signals, market analysis, and educational content. 
            ...
            <Card className="mb-8">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-4">
                  To the maximum extent permitted by law, CryptoStrategy Pro and its affiliates shall not be 
